...
from config_loader import CROSSREF_API_DELAY
...
class TestReferenceFetcher(unittest.TestCase):
    ...
    def test_respect_api_delay(self, mock_sleep, mock_get):
        ...
        # Call the new method
        self.fetcher.fetch_candidates("Hovius", "1997")

        mock_sleep.assert_called_once_with(self.delay)
    ...
    def test_fetch_not_found(self, mock_get):
        ...
        result = self.fetcher.fetch_candidates("UnknownAuthor", "2025")
    ...
    def test_returns_multiple_candidates_with_scores(self, mock_get):
        ...
        results = self.fetcher.fetch_candidates("Hovius", "1997")
    ...
    def test_parameterized_keywords(self, mock_get):
        ...
        self.fetcher.fetch_candidates("Hovius", "1997", keywords=custom_kws)
