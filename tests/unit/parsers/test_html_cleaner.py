...
@pytest.mark.parametrize(
    ...
    [
        ...
        # =====================================================================
        # Real-world Ref 2: CO2 Plumes (Newlines become standard spaces surrounding the tag)
        (
        ...
        (
            ...
            "Two Dobzhansky-Muller Genes Interact to Cause Hybrid Lethality in Drosophila. Science",
        ),
        ...
        (
            ...
            "Ocean <sup>10</sup> Be(cosmogenic)/ <sup>9</sup> Be as denudation rate proxy.",
        ),
        # =====================================================================
        ...
        (
            "Townsend, J. P. (2020). Liquid‐Vapor Coexistence and Critical Point of Mg<sub>2</sub>SiO<sub>4</sub> From Ab Initio Simulations.",
            "Townsend, J. P. (2020). Liquid‐Vapor Coexistence and Critical Point of Mg<sub>2</sub>SiO<sub>4</sub> From Ab Initio Simulations.",
        ),
        # Real-world Ref 4: Space preserved before magnitude value
        (
            "Volume Characteristics of Landslides Triggered by the M<sub>W</sub> 7.8 2016 Kaikōura Earthquake",
            "Volume Characteristics of Landslides Triggered by the M<sub>W</sub> 7.8 2016 Kaikōura Earthquake",
        ),
        ...
        (
            " Helium Low Gas Flow Measurements in the Range 10<sup>−13</sup> to 10<sup>−11</sup> mol/s (10<sup>−9</sup> to 10<sup>−7</sup> cm<sup>3</sup>/s).",
            "Helium Low Gas Flow Measurements in the Range 10<sup>−13</sup> to 10<sup>−11</sup> mol/s (10<sup>−9</sup> to 10<sup>−7</sup> cm<sup>3</sup>/s).",
        ),
...
def test_clean_to_plain_text(raw_input: str, expected_output: str) -> None:
    """Verify that HTML cleanup correctly normalizes text based on standard whitespace collapsing."""
    assert HtmlCleaner.clean_to_plain_text(raw_input) == expected_output
