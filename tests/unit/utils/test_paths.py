...
class TestOSBaseDirectories:
    ...
    def test_default_os_paths(self, target_os, mock_home, extra_env, expected_subpath):
    ...
    def test_global_app_base_dir_override(self):
...
class TestSafeDirectoryResolutionRealErrors:
    ...
    def test_fallback_triggered_by_invalid_parent_type(self, tmp_path):
    ...
    def test_fallback_triggered_by_file_collision(self, tmp_path):
